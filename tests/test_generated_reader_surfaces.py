...
'''
    ...
    def test_reader_overlays_close_outside_and_dictionary_picker_stays_compact(self):
        ...
        self.assertIn("definition.sandbox = 'allow-same-origin';", dictionary)
        self.assertIn("default-src \\'none\\'; base-uri \\'none\\'; connect-src \\'none\\';", dictionary)
        self.assertIn("script-src \\'none\\'; style-src \\'self\\' \\'unsafe-inline\\';", dictionary)
        self.assertIn('function resolveMdictResources(source, entry, bookId)', dictionary)
