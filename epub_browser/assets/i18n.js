(function(root, factory) {
  ...
  var dictionaries = {
    en: {
      ...
      'admin.ai.description': 'Configure one OpenAI-compatible model, member access, and server-managed tags. Selected book text is sent to the configured provider.',
    ...
    'zh-CN': {
      ...
      'admin.ai.description': '配置一个 OpenAI-compatible 模型、成员使用权限和服务端标签。选中的书籍文本会发送到已配置的服务提供方。',
