(function(root, factory) {
  ...
  var dictionaries = {
    en: {
      ...
      'account.associationOidcHelp': 'EPUB Browser does not connect to OIDC directly. Open it through the configured OIDC-aware trusted proxy first; this form then links that external identity to an existing local account.',
      ...
      'admin.description': 'Manage users, external identities, and access to restricted books.',
      'admin.users': 'Users',
      ...
      'admin.identities': 'External identities',
      'admin.identityHelp': 'For OIDC, let a trusted reverse proxy complete the protocol and pass a stable subject. Issuer must match --proxy-issuer; subject must match the configured subject header.',
      ...
      'admin.bookGrantsSaved': 'Book access updated.',
    ...
    'zh-CN': {
      ...
      'account.associationOidcHelp': 'EPUB Browser 不直接连接 OIDC。请先通过已配置的 OIDC 可信代理访问；随后可在此将该外部身份关联到现有本地账户。',
      ...
      'admin.identities': '外部身份',
      'admin.identityHelp': '接入 OIDC 时，由可信反向代理完成协议并传入稳定的用户主体。签发者必须与 --proxy-issuer 一致，主体必须与配置的身份请求头一致。',
      ...
      'admin.bookGrantsSaved': '书籍访问权限已更新。',
