...
<section class="account-admin account-admin-console" aria-labelledby="adminTitle">
    ...
    <section class="account-admin-section account-card-wide admin-overview-section" id="adminOverviewSection" role="tabpanel" aria-labelledby="adminSectionOverviewTab" data-admin-panel="overview">
        ...
        <section class="admin-system-limits" id="adminSystemLimits" aria-labelledby="adminSystemLimitsTitle">
            <h5 id="adminSystemLimitsTitle" data-i18n="admin.systemLimits">System limits</h5>
            <p data-i18n="admin.systemLimitsDescription">Hard limits that affect administrative actions are collected here.</p>
            <div class="admin-system-limits-grid">
                <article><h6 data-i18n="admin.systemLimits.dictionary">Dictionary import</h6><p data-i18n="admin.systemLimits.dictionaryDetail">Each file: 512 MB. StarDict archives: up to 16 files and 1 GB after extraction. MDict: up to 500,000 entries; each definition stores up to 16 KB. Referenced MDD media: 512 MB total, with no file-count limit.</p></article>
                <article><h6 data-i18n="admin.systemLimits.ai">AI configuration</h6><p data-i18n="admin.systemLimits.aiDetail">Timeout: 5–3,600 seconds. Context window: 2,048–100,000,000 tokens. Concurrency: 1–4 requests. A daily quota of 0 means no daily limit.</p></article>
                <article><h6 data-i18n="admin.systemLimits.bulk">Bulk book changes</h6><p data-i18n="admin.systemLimits.bulkDetail">Each bulk change can include up to 500 books. Updating one book's access can include up to 100 members.</p></article>
            </div>
        </section>
    ...
    <section class="account-admin-section account-card-wide" id="adminDictionariesSection" role="tabpanel" aria-labelledby="adminSectionDictionariesTab" data-admin-panel="dictionaries" hidden>
        ...
        <form class="account-form dictionary-install-form" id="adminDictionaryForm">
            <fieldset class="dictionary-format-chooser"><legend data-i18n="admin.dictionaryFormat">Dictionary format</legend><label class="dictionary-format-option is-selected"><input name="dictionary_format" type="radio" value="mdict" checked><span><strong data-i18n="admin.dictionaryFormatMdictName">MDict</strong><small data-i18n="admin.dictionaryFormatMdict">Upload an MDX dictionary, with its optional MDD media file.</small></span></label><label class="dictionary-format-option"><input name="dictionary_format" type="radio" value="stardict"><span><strong data-i18n="admin.dictionaryFormatStardictName">StarDict</strong><small data-i18n="admin.dictionaryFormatStardict">Upload one downloaded archive containing the dictionary files.</small></span></label></fieldset>
            <div class="dictionary-upload-fields" data-dictionary-upload="mdict"><label><span data-i18n="admin.dictionaryMdx">MDX dictionary file</span><span class="dictionary-file-control"><input class="dictionary-file-input" name="mdx" type="file" accept=".mdx,application/octet-stream" required aria-describedby="adminDictionaryMdxHelp"><span class="dictionary-file-button" aria-hidden="true" data-i18n="admin.chooseDictionaryFile">Choose file</span><span class="dictionary-file-name" data-dictionary-file-name="mdx" data-i18n="admin.noDictionaryFile">No file selected</span></span><small id="adminDictionaryMdxHelp" data-i18n="admin.dictionaryMdxHelp">Required. Contains words and definitions.</small></label><label><span data-i18n="admin.dictionaryMdd">MDD media file (optional)</span><span class="dictionary-file-control"><input class="dictionary-file-input" name="mdd" type="file" accept=".mdd,application/octet-stream" aria-describedby="adminDictionaryMddHelp"><span class="dictionary-file-button" aria-hidden="true" data-i18n="admin.chooseDictionaryFile">Choose file</span><span class="dictionary-file-name" data-dictionary-file-name="mdd" data-i18n="admin.noDictionaryFile">No file selected</span></span><small id="adminDictionaryMddHelp" data-i18n="admin.dictionaryMddHelp">Optional. Add the matching MDD to show images and audio included by this MDict.</small></label></div>
            <div class="dictionary-upload-fields" data-dictionary-upload="stardict" hidden><label><span data-i18n="admin.dictionaryPackage">Dictionary package</span><span class="dictionary-file-control"><input class="dictionary-file-input" name="archive" type="file" accept=".zip,.tar.gz,.tgz,.tar.bz2,.tbz2,.gz,.bz2,application/zip,application/gzip,application/x-bzip2,application/octet-stream" disabled aria-describedby="adminDictionaryPackageHelp"><span class="dictionary-file-button" aria-hidden="true" data-i18n="admin.chooseDictionaryFile">Choose file</span><span class="dictionary-file-name" data-dictionary-file-name="archive" data-i18n="admin.noDictionaryFile">No file selected</span></span><small id="adminDictionaryPackageHelp" data-i18n="admin.dictionaryPackageHelp">Choose a ZIP, .tar.gz/.tgz, or .tar.bz2/.tbz2 download containing matching .ifo, .idx, and .dict files.</small></label></div>
            <label><span data-i18n="admin.dictionaryName">Display name (optional)</span><input name="display_name" type="text" maxlength="160" autocomplete="off" aria-describedby="adminDictionaryNameHelp"><small id="adminDictionaryNameHelp" data-i18n="admin.dictionaryNameHelp">Pre-filled from the file name. You can change it.</small></label>
            <button type="submit" class="bookshelf-action-btn account-primary-action" id="adminDictionarySubmit" data-i18n="admin.installDictionary">Install dictionary</button><p class="dictionary-install-progress" id="adminDictionaryProgress" role="status" aria-live="polite" aria-atomic="true" hidden><span class="dictionary-install-progress-bar" aria-hidden="true"><span></span></span><span id="adminDictionaryProgressText"></span></p>
