...
<section class="account-admin account-admin-console" aria-labelledby="adminTitle">
    ...
    <section class="account-admin-section account-card-wide" id="adminDictionariesSection" role="tabpanel" aria-labelledby="adminSectionDictionariesTab" data-admin-panel="dictionaries" hidden>
        ...
        <form class="account-form dictionary-install-form" id="adminDictionaryForm">
            <label><span data-i18n="admin.dictionaryPackage">Dictionary package</span><input name="archive" type="file" accept=".mdx,.zip,.tar.gz,.tgz,.tar.bz2,.tbz2,.gz,.bz2,application/zip,application/gzip,application/x-bzip2,application/octet-stream" required aria-describedby="adminDictionaryPackageHelp"><small id="adminDictionaryPackageHelp" data-i18n="admin.dictionaryPackageHelp">Choose an .mdx file directly. For StarDict, choose a ZIP, .tar.gz/.tgz, or .tar.bz2/.tbz2 package containing matching .ifo, .idx and .dict files.</small></label>
